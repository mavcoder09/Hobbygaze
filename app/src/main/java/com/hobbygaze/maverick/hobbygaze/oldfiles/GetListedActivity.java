 ...
 */
public class GetListedActivity   extends Activity {
    private static final String TAG_URL = "url";
    WebView ourBrow;
    private static final String TAG = "GetListed";
    ...
    public class GeoWebChromeClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            GetListedActivity.this.setValue(newProgress);
...
//Remove notification bar
        ...
        setContentView(R.layout.get_listed_activity);
        ...
        ourBrow = (WebView) findViewById(R.id.getListedBrowser);
       ...
       // Intent in = getIntent();
        ...
        content = "http://www.hobbygaze.com/get-listed/";
       // System.out.println("URL received ="+ content);
        ...
        try {
            ...
            GetListedActivity.this.progress.setProgress(0);
